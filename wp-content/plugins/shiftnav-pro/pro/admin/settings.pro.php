...
function shiftnav_settings_panel_fields_pro( $fields = array() ){
	...
	$fields[$toggle][1010] = array(
		...
		'desc'	=> __( 'This content will appear at the left edge of the toggle bar, to the right of the toggle icon.  To pad your custom content vertically, use the class <code>shiftnav-toggle-main-block</code>.' , 'shiftnav' ),
		'type'	=> 'textarea',
	...
	$fields[$toggle][1020] = array(
		...
		'desc'	=> __( 'This content will appear at the right edge of the toggle bar.  To pad your custom content vertically, use the class <code>shiftnav-toggle-main-block</code>.' , 'shiftnav' ),
		'type'	=> 'textarea',
		'default' => '', //get_bloginfo( 'title' )
		'sanitize_callback' => 'shiftnav_allow_html',
	);
...
function shiftnav_settings_panel_fields_pro_styles( $fields = array() ){
	...
	foreach( $menus as $menu ){
		...
		$fields[SHIFTNAV_PREFIX.$menu][2500] = array(
			...
			'label'	=> __( 'Submenu Retractor Background' , 'shiftnav' ),
		...
		$fields[SHIFTNAV_PREFIX.$menu][2510] = array(
			...
			'label'	=> __( 'Submenu Retractor Font Color' , 'shiftnav' ),
		...
		$fields[SHIFTNAV_PREFIX.$menu][2520] = array(
			...
			'label'	=> __( 'Submenu Retractor Alignment' , 'shiftnav' ),
